...
public class HomeController {
    ...
    public ResponseEntity<?> permiteAcesso(){
        Usuario usu = new Usuario(1,"permite acesso sem login", "1234");
    ...
    public ResponseEntity<?> permiteAcesso2(@RequestParam("s1") String s1){
        Usuario usu = new Usuario(1,s1+"permite acesso passando variável", "1234");
    ...
    public ResponseEntity<List<Usuario>> listaUsuariosPublico(){
        Usuario usu1 = new Usuario(1,"usu 1", "1234");
        Usuario usu2 = new Usuario(1,"usu 2", "1234");
    ...
    public ResponseEntity<?> permiteAcesso2(){
        Usuario usu = new Usuario(1,"publico", "1234");
        return new ResponseEntity<Usuario>(usu, HttpStatus.OK);
    }
    ...
    public ResponseEntity<?> onlyAuthenticated(@AuthenticationPrincipal UserDetails auth){
        Usuario usu = new Usuario(1,auth.getUsername()+"Autenticado passando detalhes do usuario", "1234");
    ...
    public ResponseEntity<?> onlyAdmin(){
        Usuario usu = new Usuario(1,"Apenas ADMIN", "1234");
        return new ResponseEntity<Usuario>(usu, HttpStatus.OK);
    }
